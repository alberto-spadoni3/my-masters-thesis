...
Il presente capitolo tratta un'analisi qualitativa del sistema legacy, che inizia con una panoramica sulle funzionalità principali, per poi descriverne l'architettura e le tecnologie scelte per la sua implementazione. Verranno discusse anche le limitazioni ed i problemi che hanno costretto l'azienda ad iniziare un processo di reigegnerizzazione completa.
...
\section{Architettura del software legacy}
