...
Infine, una caratteristica delle RPZ degan di nota, è che, per loro natura, sono in grado di proteggere solo da minaggie già conosciute  \cite{Magnusson2024}.

\paragraph{Threat Intelligence Feeds (TIF)}

\paragraph{Domain Generation Algorithm (DGA)}
